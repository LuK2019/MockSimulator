...
class TrajectoryDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return normalized_trajectory.view(32, 4), torch.tensor([reward], dtype=torch.float32)
...
def train_value_network(dataset, model, optimizer, criterion, num_epochs=10, batch_size=32):
    ...
    save_checkpoint(model, optimizer, num_epochs, final_loss, os.path.join('models', '32_new_value_model_final.ckpt'))
...
if __name__ == "__main__":
    dataset_file_path = '/home/bearhaon/MockSimulator/logs/new_planner_buffer_20231213-231917.pkl' 
    ...
    last_epoch = train_value_network(dataset, value_model, optimizer, criterion, num_epochs=500, batch_size=32)